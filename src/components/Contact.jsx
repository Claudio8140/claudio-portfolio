...
// template_0b00tbq   template ID
// service_p1y9baq    service ID
// J-wfMNlOcYd4us7TB  public key
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then(
        () => {
          setLoading(false);
          alert("Merci bien. Je reviens vers vous le plus vite possible.");
        ...
        (error) => {
          ...
          alert("Ahh, quelques chose s'est mal passé. Veuillez réessayer.");
        }
      );
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {loading ? "En train d'envoyer..." : "Envoyer"}
          </button>
        </form>
      </motion.div>
